        ...
        match self {
            ...
            FormatterOptions::FormatCurrency => [
                ...
                &[
                    ...
                    icu::experimental::dimension::provider::currency::symbols::CurrencySymbolsV1::INFO,
                    icu::experimental::dimension::provider::currency::fractions::CurrencyFractionsV1::INFO,
                ],
            ]
            .iter()
            .flat_map(|m| m.to_vec())
